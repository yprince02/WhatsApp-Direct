    ...
    <SafeAreaView>
      <ScrollView
        ...
        <Text style={[styles.heading, step == 3 && {marginBottom: 0}]}>
          {step == 1 ? (
            <>
              WhatsApp-Direct <Text style={{color: ColorCodes.Blue}}>Pro</Text>
            </>
          ) : step == 2 ? (
            <>No contact needed</>
          ) : (
        ...
        <View style={{paddingVertical: 10}}>
          {step == 1 ? (
            ...
            <Image
              source={{
                uri: 'https://img.icons8.com/bubbles/200/000000/contacts.png',
              }}
              style={styles.image}
            />
          ) : null}
        ...
        <View style={{flexDirection: 'row'}}>
          {step == 1 ? (
            <Text style={styles.introInfo}>
              Send messages and files without saving phone number to anyone
            </Text>
          ) : step == 2 ? (
            <View style={styles.introInfo}>
              ...
              <Text style={[styles.stepsSm]}>
                Just enter number and send message to anyone in typically 2
                simple steps. Hurray!!
                </Text>
            </View>
          ) : (
            <View style={{width: '100%'}}>
              <View style={styles.stepsC}>
                <Image
                  source={{
                    uri: 'https://img.icons8.com/bubbles/100/000000/phone.png',
                  }}
                  style={styles.icon}
                />
                <View style={styles.steps}>
                  ...
                  <Text style={[styles.stepsSm]}>
                    Copy and paste the phone number to which you want to send
                    message
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.stepsC}>
                <Image
                  source={{
                    uri: 'https://img.icons8.com/bubbles/100/000000/chat.png',
                  }}
                  style={styles.icon}
                />
                <View style={styles.steps}>
                  ...
                  <Text style={[styles.stepsSm]}>
                    Type the message you want to send (OPTIONAL)
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.stepsC}>
                <Image
                  source={{
                    uri: 'https://img.icons8.com/bubbles/100/000000/send-message-male.png',
                  }}
                  style={styles.icon}
                />
                <View style={styles.steps}>
                  ...
                  <Text style={[styles.stepsSm]}>
                    Click the SEND button. Hurray! Enjoy your chat
                  </Text>
                </View>
              </View>
            </View>
